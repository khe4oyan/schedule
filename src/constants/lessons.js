...
export default [
  ...
  [ // Вторник
    ...
    new SingleLesson("Գրաֆ․ ինտեր․ ծրագր․ Լաբ․", "5706, 5117", "Մանուկյան  Վ․ Սաֆարյան Ա․", "11:00", "12:20"),
    new SingleLesson("Կազմակ․ մարքեթ․ գործ․  Դաս, Գործ", 5011, "Վարդանյան Գ․", "12:50", "14:10"),
    new DoubleLess(
      null,
      new SingleLesson("Դինամիկ վեբ կայքերի նախագծում Լաբ.1", 5122, "Մխիթարյան Լ․", "14:20", "15:40"),
    ),
  ],

  [ // Среда
    new SingleLesson("Կետային գրաֆիկա լաբ․", "5104, 5119", "Ռահանյան Գ․ Նորեկյան Ա․", "09:30", "10:50"),
    new SingleLesson("Տեղեկատվ․ անվտանգություն․ Լաբ․", "5104, 5104", "Մինասյան Լ․ Մխիթարյան Լ․", "11:00", "12:20"),
  ...
  [ // Четверг
    new SingleLesson("Կետային գրաֆիկա լաբ.", "5108, 5120", "Ռահանյան Գ. Նորեկյան Ա.", "09:30", "10:50"),
  ...
  [ // Пятница
    ...
    new SingleLesson("Դինամիկ վեբ կայքերի նախագծում Լաբ.", "51009, 51009", "Պողոսյան Մ․ Մխիթարյան Լ․", "14:20", "15:40"),
  ],
];