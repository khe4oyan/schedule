...
export default [
  ...
  [ // Вторник
    ...
    new Lesson("Գրաֆ․ ինտեր․ ծրագր․ Լաբ․", 5706, "Մանւկյան Վ․ Սաֆարյան Ա․", "11:00", "12:20"), // 5117
    new Lesson("Կազմակ․ մարքեթ․ գործ․  Դաս, Գործ", "12:50", "14:10"),
    new DoubleLess(
      null,
  ...
  [ // Среда
    new Lesson("Կետային գրաֆիկա լաբ․", 5104, "Ռահանյան Գ․ Նորեկյան Ա․", "09:30", "10:50"), // 5119
    new Lesson("Տեղեկատվ․ անվտանգություն․ Լաբ․", 5104, "Մինասյան Լ․ Մխիթարյան Լ․", "11:00", "12:20"), // 5104 սխալ չի
  ...
  [ // Четверг
    new Lesson("Կետային գրաֆիկա լաբ․", 5108, "Պողոսյան Մ․", "09:30", "10:50"), // 5120
